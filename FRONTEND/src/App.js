...
function App() {
  ...
  useEffect(() => {
    // Set dark mode by default like CompeteHub
  ...
  return (
    <div className="w-screen min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col font-inter transition-colors">
      <LoadingBar
        color="#3B82F6"
        height={2}
        progress={progress}
      ...
      {!navigator.onLine && (
        <div className="bg-red-500 flex text-white text-center p-2 justify-center gap-2 items-center">
          ...
          <button
            className="ml-2 bg-red-600 hover:bg-red-700 rounded-md p-1 px-3 text-white transition-colors"
