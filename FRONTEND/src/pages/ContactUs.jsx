...
const ContactUs = () => {
  return (
    <div>
        <div className='mx-auto mt-20 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 dark:text-white text-gray-900 lg:flex-row'>
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm dark:text-richblack-200 text-gray-400'>
                    ...
                    <h1 className="text-lg font-semibold dark:text-richblack-5 text-gray-900">Chat on us</h1>
                    </div>
                ...
                <div className="flex flex-col gap-[2px] p-3 text-sm dark:text-richblack-200 text-gray-400">
                    ...
                    <h1 className="text-lg font-semibold dark:text-richblack-5 text-gray-900">Visit us</h1>
                    </div>
                ...
                <div className="flex flex-col gap-[2px] p-3 text-sm dark:text-richblack-200 text-gray-400">
                    ...
                    <h1 className="text-lg font-semibold dark:text-richblack-5 text-gray-900">Call us</h1>
                </div>
        ...
        <div className='lg:w-[60%]'>
            <div className='border border-richblack-600 dark:text-richblack-300 text-gray-600 rounded-xl p-7 lg:p-14 flex gap-3 flex-col'>
                <h1 className='text-4xl leading-10 font-semibold dark:text-richblack-5 text-gray-900'>
        ...
        <div className='relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 dark:text-white text-white'>
                    <h1 className='text-center text-4xl font-semibold mt-8 dark:text-white text-white'>
